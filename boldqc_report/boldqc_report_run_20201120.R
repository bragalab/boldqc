...
rotPLOT <- paste(FILENAME, "_skip_mc_rot.png", sep = "")
rotPLOTimg <- readImage(rotPLOT)
gROT <- rasterGrob(rotPLOTimg)
transPLOT <- paste(FILENAME, "_skip_mc_trans.png", sep = "")
transPLOTimg <- readImage(transPLOT)
gTRANS <- rasterGrob(transPLOTimg)
absdispPLOT <- paste(FILENAME, "_skip_mc_disp_abs.png", sep = "")
absdispPLOTimg <- readImage(absdispPLOT)
gABSDISP <- rasterGrob(absdispPLOTimg)
reldispPLOT <- paste(FILENAME, "_skip_mc_disp_rel.png", sep = "")
