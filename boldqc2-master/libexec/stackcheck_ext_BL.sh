...
libdir=/projects/b1134/tools/boldqc/boldqc2-master/libexec/helpers.sh
. $libdir || exit 1;
...
if [ "$skip_stackcheck" = "" ]; then
    ...
    cmd="/projects/b1134/tools/boldqc/boldqc2-master/stackcheck/stackcheck_nifti --threshold $thresh --skip $skip --report --mean --mask --stdev --snr --plot --input $nifti_file --output-basename ${outdir}/${base}"
